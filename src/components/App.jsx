...
//   }
  ...
  return (
    <div className="container backdrop-sepia-0 bg-neutral-100 bg-opacity-10 sm:w-[500px] w-72 shadow-lg shadow-transparent/10 mt-20 m-auto p-20 text-center rounded-xl h-96">
